...
async def delete_laia_base_model(element_id: str, model: Type, user_roles: List[str], repository: ModelRepository, use_access_rights: bool = True, user_shard: str = "", user_id: str = "", smtp_config: Optional[dict] = None, audit_context: dict = None):
