...
async def update_laia_user(element_id:str, updated_values: dict, model: LaiaUser, user_roles: list, crud_instance: ModelRepository, user_shard: str = "", smtp_config: dict = None, use_access_rights: bool = True, user_id: str = ""):
    ...
    user = await update_laia_base_model(element_id, {**updated_values}, model, user_roles, crud_instance, use_access_rights, user_shard, smtp_config, user_id=user_id)
